...
class CpuAMDSeeder extends Seeder
{
    /**
    ...
    public function run(): void
    {
        ...
        $json = file_get_contents(database_path('seeders/data-crawl/cpu-amd.json'));
        ...
        foreach ($cpus as $cpu) {
            ...
            $accessory = Accessory::create([
                ...
                "data_sheet" => $cpu['table']?? null,
            ]);
            $post = Post::create([
                'type' => "PRODUCT",
                'content' => $cpu['body_html'] ?? "Sản phẩm này chưa có mô tả",
                'images' => json_encode([
            ...
            $product = Product::create([
                ...
                'cost' => $cpu['cost']/100,
                'price' => $cpu['price'] ==0 ?$cost + 1000000 : $cpu['price']/100,
                'images' => $cpu['images'],
                'post_id' => $post->id,
                'category_id' => 10,

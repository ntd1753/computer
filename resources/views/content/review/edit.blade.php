...
@section('content')
    @component('components.breadcrumb')
        ...
        @endslot
        @slot('title')
            Chi tiết đánh giá và bình luận sản phẩm
        @endslot
    @endcomponent
    <form action="{{route('review.update',['id'=>$review->id])}}" method="POST" enctype="multipart/form-data" class="frm_form_add">
        @csrf
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title">Thông tin chí tiết</h4>

                        <div class="row">
                            <div class="">
                                <div class="mb-3">
                                    <label for="name">Tên Sản Phẩm</label>
                                    <input id="name" type="text" class="form-control" value="{{$review->product->name}}" disabled
                                    >
                                </div>
                            </div>
                            <div class="">
                                <div class="mb-3">
                                    ...
                                    <input id="name"  type="text" class="form-control" value="{{$review->user->email}}" disabled
                                    >
                                </div>
                            </div>
                            <div class="">
                                <div class="mb-3">
                                    ...
                                    <input id="name"  type="text" class="form-control" value="{{$review->user->name}}" disabled
                                    >
                                </div>
                            </div>
                            <div class="">
                            ...
                            <div class="">
                                <div class="mb-3">
                                    ...
                                    <input id="name"  type="text" class="form-control" value="{{$review->review_content}}" disabled
                                    >
                                </div>
                            </div>
                            <div class="">
                            ...
                            <div class="">
                                <div class="mb-3">
                                    <label for="name">Nội dung</label>
                                    <textarea id="name"  type="text" class="form-control" name="reply_content"
                                    >{{$review->replies->first()->review_content ?? ''}}</textarea>
                                </div>
                            </div>
                        </div>
                    </div>

...
@section('content')
    @component('components.breadcrumb')
        ...
        @endslot
    @endcomponent
    <form action="{{route('prebuiltPc.update',['id'=>$prebuiltPC->id])}}" method="POST" enctype="multipart/form-data" class="frm_form_add">
    @csrf
        <div class="row">
            <div class="col-12">
                <div class="card">
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="mb-3">
                                    ...
                                    <input id="name" name="name" type="text" class="form-control" value="{{$prebuiltPC->name}}"
                                    >
                                </div>
                                <div class="mb-3">
                                    <label for="slug">Loại Sản Phẩm</label>
                                    <input id="slug" type="text"
                                           class="form-control" value="{{strtoupper($prebuiltPC->type)}}"
                                           disabled>
                                ...
                                <div class="mb-3">
                                    ...
                                    >
                                        ...
                                        <option value="{{\App\Models\Product::DISCOUNT_PERCENT}}"
                                                @if($prebuiltPC->discount_type == \App\Models\Product::DISCOUNT_PERCENT)
                                                    selected
                                            @endif>
                                            Giảm Phần Trăm
                                        </option>
                                        <option value="{{\App\Models\Product::DISCOUNT_VND}}"
                                                @if($prebuiltPC->discount_type == \App\Models\Product::DISCOUNT_VND)
                                                    selected
                                            @endif>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input id="quantity" name="quantity" type="number" class="form-control" value="{{$prebuiltPC->quantity}}">
                                </div>
                            </div>
                            ...
                            <div class="col-sm-6">
                                ...
                                <div class="mb-3">
                                    ...
                                    >
                                        ...
                                        @foreach($brands as $brand)
                                            @if($prebuiltPC->brand_id == $brand->id)
                                ...
                                <div class="mb-3">
                                    ...
                                    <input id="price" name="price" type="text" class="form-control" value="{{$prebuiltPC->price}}"
                                           placeholder="Price">
                                </div>
                                <div class="mb-3 row">
                                    <div class="col-10">
                                        ...
                                        <input id="discount-value" name="discount_value" type="text"
                                               class="form-control" value="{{$prebuiltPC->discount_value??""}}"
                                               @if(!$prebuiltPC->discount_type)
                                                   disabled
                                            @endif
                                        >
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        @include('components.product.prebuiltPC', ['item' => $prebuiltPCDetail])
                    </div>
                </div>
                <div class="card">
                    <div class="card-body row">
                                ...
                                <div class="col-8">
                                    <div class="gallery_container">
                                        <div id = "image_container" class="image_container property_gallery">
                                            @php
                                                $previewImgs = json_decode($prebuiltPC->images, true);
                                            @endphp
                        ...
                        <div class="col-4">
                            ...
                            <textarea id="dataSheet" name="dataSheet">
                                @if($prebuiltPCDetail->data_sheet)
                                    {!! $prebuiltPCDetail->data_sheet !!}
                                @else
                ...
                <div class="card">
                    @include("components.product.post",['item'=>$prebuiltPC->post])
                </div>
            </div>
        </div>

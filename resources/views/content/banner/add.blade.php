...
@section('content')
    @component('components.breadcrumb')
        ...
        @endslot
    @endcomponent
    <form action="{{route('banner.store')}}" method="POST" enctype="multipart/form-data" class="frm_form_add">
    @csrf
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <div class="row">
                        <div class="col-sm-6">
                            ...
                            <div class="mb-3">
                                <label for="metatitle">link</label>
                                <input id="metatitle" name="link" type="text" class="form-control" value=""
                                       placeholder="">
                            </div>
                            <div class="mb-3">
                                <label for="metakeywords">Vị trí Banner</label>
                                <input id="metakeywords" name="position" type="number" class="form-control" value=""
                                       placeholder="Vị trí hiện Banner 1, 2, 3, ....">
                            </div>
                            <div class="mb-3">
                        ...
                        <div class="mb-3 col-sm-6">
                            <label for="name" class="form-label">Banner</label><br>
                            <input type="hidden" name="image" id="image_label">

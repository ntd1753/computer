...
@section('content')
    @component('components.breadcrumb')
        ...
        @endslot
    @endcomponent
    <form action="{{route('post.store')}}" method="POST" enctype="multipart/form-data" class="frm_form_add">
    @csrf
    <div class="row">
        <div class="col-12">
            <div class="card">
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="mb-3">
                                ...
                                <input id="name" name="name" type="text" class="form-control" placeholder="Nhập tiêu đề">
                            </div>
                            <div class="mb-3">

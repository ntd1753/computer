@foreach($posts as $item)
    ...
    <tr>
        ...
        <td class="w-40">
            <div class="font-size-14 text-dark">{!! $item->description !!}</div>
        </td>
        ...
        <td >
            <div class="d-flex align-items-center justify-content-center w-100 text-center">
                ...
                <div><a href="#" data-bs-toggle="modal" data-bs-target="#seo-modal-{{$item->id}}"><i class="bx bx-spreadsheet fs-3 fw-medium text-primary"></i></a></div>

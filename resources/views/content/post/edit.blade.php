...
@section('content')
    @component('components.breadcrumb')
        ...
        @endslot
    @endcomponent
    <form action="{{route('post.edit', $item->id)}}" method="POST" >
        @csrf
        <div class="row">
            <div class="col-12">
                <div class="card">
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="mb-3">
                                    ...
                                    <input id="name" name="name" type="text" class="form-control" placeholder="Nhập tiêu đề" value="{{$item->title}}">
                                </div>
                                <div class="mb-3">
                            ...
                            <div class="mb-3 col-sm-6">
                                ...
                                <input type="hidden" name="images" id="image_label" value="{{$item->images}}">
                                <div class="row justify-content-center ">
                                    <img id="img_preview" src="{{$item->images ?? asset('build/images/default-preview-img.jpg') }}"><br>
